...
(function($) {
	...
	vkbeautify.prototype.sqlmin = function(text) {
		...
		vkbeautify.prototype.html = function(html_source) {
			var indent_size = this.tabsize,
				indent_character = this.tabchar,
				max_char = this.maxchar;
			...
			function Parser() {
				...
				this.get_token = function() { //initial handler for token-retrieval
					...
					if (this.last_token === 'TK_TAG_SCRIPT') { //check if we need to format javascript
						...
						token = $.format(temp_token, {
							method: 'javascript',
							tabsize: this.indent_size,
							tabchar: this.indent_character,
		...
		vkbeautify.prototype.javascript = function(js_source_text) {
			var indent_size = this.tabsize,
				indent_character = this.tabchar,
				indent_level = this.level;
		...
		vkbeautify.prototype.text = function(text) {
			return text;
		},
