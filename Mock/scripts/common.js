define(function(require, exports, module) {
	var EditSession = require("../../scripts/ace/edit_session").EditSession;
	var UndoManager = require("../../scripts/ace/undomanager").UndoManager;
	var Editor = require("../../scripts/ace/editor").Editor;
	var Renderer = require("../../scripts/ace/virtual_renderer").VirtualRenderer;
